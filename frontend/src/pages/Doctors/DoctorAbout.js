    ...
    <div>
      <div>
        ...
        <p className="text__para">
          hsdbcdbjccano jsisnlk jbjnsii nixsnoaxmosmx ninck cksci iinsisxks
          jbinxksxiksj kj bxknsixnsi x isxljkskjxn bkj iu ki kj skj sai sjk csk
          ksaj c
        </p>
      </div>
      ...
      <div className="mt-12">
        ...
        <ul className="pt-4 md:p-5">
          <li className="mb-[30px]">
            <div>
              <span className="text-irisBlueColor text-[15px] leading-6 font-semibold ">
                {formateDate("07-30-2014")} - {formateDate("09-13-2016")}
              </span>
          ...
          <li className="mb-[30px]">
            <div>
              <span className="text-irisBlueColor text-[15px] leading-6 font-semibold ">
                {formateDate("12-04-2010")} - {formateDate("07-30-2014")}
              </span>
              <p className="text-[16px] leading-6 font-medium text-textColor ">
                PHD in Surgeon
              </p>
