...
const Profile = ({ user }) => {
  ...
  useEffect(() => { setFormData({name: user.name, email:user.photo, gender:user.gender, bloodType:user.bloodType})},[user]);
      ...
      <form onSubmit={submitHandler}>
        ...
        <div className="mb-5">
          <input
            ...
            onChange={handleInputChange}
            className="w-full pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[22px] leading-7 cursor-pointer aria-readonly readOnly"
          />
        </div>
        ...
        <div className="mb-5">
          <input
            ...
            onChange={handleInputChange}
            className="w-full pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[22px] leading-7 cursor-pointer"
          />
        </div>
